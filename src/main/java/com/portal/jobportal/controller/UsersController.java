...
import com.portal.jobportal.service.UserTypeService;
...
public class UsersController {
    ...
    public String register(Model model){
        ...
        List<UsersType> userTypeList = userTypeService.getAll();
        //user*
    ...
    public String userRegistration(@Valid Users users, Model model){
       ...
       if(optionalUsers.isPresent()){
           // If email already present shows error msg and return to the register form

           model.addAttribute("error", "Email Id already present");
           List<UsersType> userTypeList = userTypeService.getAll();
           //user*
           model.addAttribute("getAllTypes", userTypeList);
           model.addAttribute("user",new Users());
